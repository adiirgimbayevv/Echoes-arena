...
public class CombatSystem {
    ...
    public Projectile spawnProjectile(float x, float y, Vector2 direction,
                                      ...
                                      HitData hitData) {
        return spawnProjectile(x, y, direction, speed, radius, maxRange, hitData, false);
    }

    public Projectile spawnProjectile(float x, float y, Vector2 direction,
                                      float speed, float radius, float maxRange,
                                      HitData hitData, boolean fromPlayer) {
        Projectile projectile = new Projectile(x, y, direction, speed, radius, maxRange, hitData, fromPlayer);
